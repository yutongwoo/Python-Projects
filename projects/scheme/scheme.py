...
def eval_all(expressions, env):
    ...
    if expressions == nil:
        ...
        result = scheme_eval(expressions.first, env, True) #True
        return result
    # END PROBLEM 8
...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        if len(formals) != len(vals):
            ...
            i = 1
            while i <= len(formals) or formals!= nil or vals!=nil:
    ...
    if len(expressions) == 0:
        ...
        while expressions.second != nil:
            if scheme_falsep(scheme_eval(expressions.first,env)):
                return False
            expressions = expressions.second
        if scheme_falsep(scheme_eval(expressions.first,env,True)): #True
            return False
        else:
...
def do_or_form(expressions, env):
    ...
    if len(expressions) == 0:
        ...
        while expressions.second != nil:
            ...
            expressions = expressions.second
        if scheme_truep(scheme_eval(expressions.first, env, True)): #True
            return scheme_eval(expressions.first, env, True)
        else:
            return False
    # END PROBLEM 13
