...
(define (list-change total denoms)
  ...
  (cond
    ...
    ((= (car denoms) total) (cons (list-change (- total (car denoms)) denoms) (cons (list-change total (cdr denoms)))) )
    (else (cons-all (car denoms) (list-change (- total (car denoms)) (cdr denoms))))
  ))
